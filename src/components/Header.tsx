      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="#home" className="block px-3 py-2 text-gray-700 hover:text-gray-900">Ana Sayfa</a>
            <a href="#about" className="block px-3 py-2 text-gray-700 hover:text-gray-900">Hakkımda</a>
            <a href="#projects" className="block px-3 py-2 text-gray-700 hover:text-gray-900">Projeler</a>
            <a href="#skills" className="block px-3 py-2 text-gray-700 hover:text-gray-900">Yetenekler</a>
            <a href="#contact" className="block px-3 py-2 text-gray-700 hover:text-gray-900">İletişim</a>
          </div>
        </div>
      )}
    </header>
